...
void main(array<String^>^)
{
	...
	csv_log_consumer* csvLogConsumer = new csv_log_consumer("logIncoherentDNovy.csv");
...
// MainForm:
	...
	System::Void gui::MainForm::LogDuration(size_t size, tests::DurationTime duration, const std::string& message)
	{
