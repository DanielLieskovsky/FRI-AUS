...
namespace structures
{
    ...
    public:
        ...
        virtual void logDuration(size_t size, DurationTime duration, const std::string& message) = 0;
    };
    ...
    public:
        ...
        void logDuration(size_t size, DurationTime duration, const std::string& message);
